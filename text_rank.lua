...
function App:printHelp()
    print("Usage: luajit test_thulua.lua 'WORD_VECTORS.TXT' 'SUMMARIZE_COUNT' 'INPUT_TEXT'")
end
...
function App:main(word_vectors_text, summarize_count, input_text)
    assert(word_vectors_text, "no vector text provide")
    assert(summarize_count, "no summarize count provide")
